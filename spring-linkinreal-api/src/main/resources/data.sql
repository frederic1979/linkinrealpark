...
insert into place (id, label, street_number, street, postal_code, city) values (place_seq_id.nextval, 'Le Louvre', 140, 'Rue de Rivoli', 75001, 'Paris');
insert into place (id, label, street_number, street, postal_code, city) values (place_seq_id.nextval, 'Arena Bercy', 8, 'Rue de Bercy', 75011, 'Paris');
insert into place (id, label, street_number, street, postal_code, city) values (place_seq_id.nextval, 'Opera', 1, 'Rue de l''Opera', 75009, 'Paris');
